...
// Talks directly to deployed backend — no localStorage fallback
// ============================================
...
// No-op kept for compatibility — localStorage no longer used
...
export async function getDonorNameSync(_donorId: number): string {
  return 'Loading...';
}
